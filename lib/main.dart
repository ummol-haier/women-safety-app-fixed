import 'package:ally/database/db_helper.dart';
...
class MyApp extends StatelessWidget {
  ...
  Future<Widget> _getInitialScreen() async {
    // Remove this line after development to preserve login/session:
    // await DBHelper().deleteOldDatabaseIfExists(); // ✅ DELETE DB DURING DEV
